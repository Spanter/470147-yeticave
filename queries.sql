...
VALUES
('2015 Rossignol District Snowboard', 'Описание товара', 'img/lot-1.jpg', '2018-05-3 00:00:00', '2018-05-4 00:00:00', 1000, 10999, 1, 3, 1),
('DC Ply Mens 2016/2017 Snowboard', 'Описание товара', 'img/lot-2.jpg', '2018-05-4 00:00:00', '2018-05-5 00:00:00', 2800, 15999, 1, 2, 3),
('Крепления Union Contact Pro 2015 года размер L/XL', 'Описание товара', 'img/lot-3.jpg', '2018-05-15 00:00:00', '2018-06-3 00:00:00', 750, 8000, 2, 2, 4),
('Ботинки для сноуборда DC Mutiny Charoca', 'Описание товара', 'img/lot-4.jpg', '2018-05-6 00:00:00', '2018-05-7 00:00:00', 990, 10999, 3, 1, 2),
('Куртка для сноуборда DC Mutiny Charocal', 'Описание товара', 'img/lot-5.jpg', '2018-05-7 00:00:00', '2018-05-8 00:00:00', 700, 7500, 4, 1, 3),
('Маска Oakley Canopy', 'Описание товара', 'img/lot-5.jpg', '2018-05-8 00:00:00', '2018-05-9 00:00:00', 500, 5400, 6, 4, 2);
...
SELECT name, create_date, img, start_price, end_date, finish_price, author_id, cat_name
FROM lot JOIN categories using(id) WHERE id=1;
...
SELECT name, start_price, img, finish_price, COUNT(bet.id), cat_name
FROM lot JOIN  bet using(id) JOIN categories using(id)
WHERE NOW() < end_date
GROUP BY id ORDER BY create_date ASC;
